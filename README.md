...
##  What's new?
  ...
  - no cavalry
  - new units like tanks, planes, helicopters, submarines and UAVs
...
## Tipps:
  ...
  - Some factions have 6th Generation fighters. These in combat group with drones are able to attack targets behind the enemies' lines, although the enemy has maybe taken strong anti-aircraft measures (usefull if there's a sea between you and the enemy).
  ...
  - Allways combine Tanks with self-propelled surface-to-air-missle systems, due to their vulnerability from the air.
